...
const quotes = [
  "выпей стакан чистой воды и запиши в трекер",
   
  "напиши в дневник настроения как ты себя чувствуешь",

  "не взвешивайся каждый день, лучше делать замеры тела",

  "не забудь выпить капсулу, если ты на курсе",

  "еще немного и ты достигнешь своей цели",

  "если ты не видишь результата — не опускай руки! это точно замечают другие",

  "ты больше, чем цифры на весах, в приложении или на бирке одежды",

  "запиши сколько времени ты уже без срывов"
];
...
const sections = {
  ...
  calculations: {
   ...
   delicate: {
    ...
    kicker: "delicate themes",

    description:
      "все мы живые люди и порой у нас случаются неприятные темы, которыми не принято делиться",

    topics: [
      {
        id: "obstruction",
        title: "запоры на/после курсах",
        description: "из-за чего, как фиксить, разрешенные/запрещенные слабительные"
      },

      {
        id: "period",
        title: "менструация на курсе",
        description: "как проходит, какие могут быть последствия; аменорея, дисменорея и причины их появления"
      }
    ]
  },   

   beauty: {
    title: "молекулярная красота",

    kicker: "skin care",

    description:
      "волнующая большое количество человек тема, потому что на курсе начинают старадать кожа, волосы и ногти",

    topics: [
      {
        id: "skin-rashes",
        title: "высыпания на лице или теле",
        description: "эта проблема не является чем-то страшным и постыдным, но не отменяет личного дискомфорта, неуверенности и волнения"
      },

      {
        id: "hair-loss",
        title: "выпадение волос и их обламывание",
        description: "эта тема особо болезненна для девушек, потому что мысли о каре вгоняют в истерику, а количество волос, остающихся на расческе – в депрессию"
      },

      {
        id: "brittle-nails",
        title: "ломкость ногтей",
        description: "ногти и их состояние часто оказываются обделенными в уходовой рутине как на курсе, так и нет"
      }
    ]
  },
   ...
   links: {
    ...
    description:
      "важное предупреждение: в этом разделе опубликованы официальные ссылки на все наши соц.сети<br>ссылки, которые здесь не указаны – мошеннические!",
      };
...
const articles = {
  ...
  "supplements": {
    ...
    category: "Какой из БАДов подойдет тебе",
    ...
    pages: [

      {
        ...
        content: `
            Подходит тем, кто желает избавиться от лишних килограммов
            за достаточно быстрое время
            Молекула Плюс также способствует нормализации работы желудка,
            но имеет выраженные побочные эффекты
        `
      },
       {
        heading: "Сколько возможно скинуть",
        content: `
            Если Ваш ИМТ ниже нормы: 3-6кг<br>
            Если Ваш ИМТ в норме: 5-10кг<br>
            Если Ваш ИМТ выше нормы: до 15кг
        `
      }
