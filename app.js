...
const content = {
  rpp: {
    ...
    body: `
      ...
      <ul><h3 class="note">что делать, когда усиливаются навязчивые мысли о еде и теле</h3>
</ul>
<h3 class="note">как переживать сильный позыв к компенсаторному поведению</h3>
</ul>
<h3 class="note">почему восстановление может идти неровно</h3>
</ul>
<h3 class="note">как отличать заботу о здоровье от поведения РПП</h3>
      </ul>
