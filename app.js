  ...
  "medical-vitamins": {
    ...
    pages: [
       ...
       
      {
        ...
        content: `
             <p>
             <b>предупреждение</b>: витамины не являются обязательными для приема на курсе
             так как если у тебя нет диагностированного дефицита хотя бы одного
             из витаминов, может быть риск развития авитаминоза
