...
const quotes = [
  <i>"мы не обязаны заслуживать право на еду, отдых и заботу о себе",
  ...
  "тебе можно уставать, а главное — можно остановиться",

  "восстановление не обязано быть идеальным, чтобы быть настоящим</i>",

  "ты больше, чем цифры на весах, в приложении или на бирке одежды",

  "еда не делает из тебя хорошего или плохого человека. это еда, а не моральный тест"</i>
];
