  ...
  "medical-vitamins": {
    ...
    pages: [
      ...
      <div class="info-box">
         ...
         <h3>прочие препараты, которые не следует пить</h3>
          ...
          <ul>
            ...
            <li>МИПП (Омез, Нексиум, Омепразол)</li>
      ...
      <div class="info-box">
           ...
           а также, слабительное действие вызывает <b>Магния Цитрат, Оротат</b><br>
           вызывает гиперстимуляцию сердечка – <b>Магния Фосфат</b>
            </p>
          </div>
         ...
         <h3>кальций + витамин D3</h3>
          <p>
         хоть мы и получаем ежедневно дозу кальция из нашей еды, МБАДы для похудения вымывают незначительную часть минерала из организма
         кальций лучше всего усваивается при единовременном приеме с витамином D3(обычно, в БАДах они уже идут вместе)
          </p>
 
          <p>
          <b>рекомендуемые дозы</b>: мг в сутки, в дневное время, до/во время еды
          </p>   
          ...
          <p>
           ...
           потемнения в глазах, спазма мышц и тремора конечностей
           рекомендуется покупать минеральную воду или препарат Регидрон, в составе которых
        ...
        content: `
         ...
         судорогами и резким повышением температуры</li>
          ...
          <h3>сульфат железа</h3>
           <ul>  
         <li>так же как и многие БАДы для похудения вызывает запор
         также, нельзя пить «тяжелые» формы железа, так как в разы могут
