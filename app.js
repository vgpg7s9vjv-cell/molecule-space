...
style="width: 100%; height: auto; border-radius: 12px; margin: 15px 0; display: block;">
  ...
  "supplements-voice": {
    ...
    pages: [
      ...
      {
        heading: "Молекула Plus",

        content: `
           <p>
             <b>базовая база</b><br>
             подходит тем, кто желает избавиться от лишних килограммов за достаточно быстрое время<br>
             Плюс также способствует нормализации работы желудка, но имеет <b>довольно выраженные</b> побочные эффекты
          </p>
