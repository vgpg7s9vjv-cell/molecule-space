...
const quotes = [
  "<i>мы не обязаны заслуживать право на еду, отдых и заботу о себе</i>",

  "<i>твой самый трудный день не отменяет весь путь, который был пройден</i>",

  "<i>тело не является экзаменом, который нужно сдать на определенный размер</i>",

  "<i>один прием пищи не способен определить твою ценность</i>",

  "<i>тебе можно уставать, а главное — можно остановиться</i>",

  "<i>восстановление не обязано быть идеальным, чтобы быть настоящим</i>",

  "<i>ты больше, чем цифры на весах, в приложении или на бирке одежды</i>",

  "<i>еда не делает из тебя хорошего или плохого человека. это еда, а не моральный тест</i>"
];
...
const sections = {
  ...
  rpp: {
    ...
    kicker: "расстройство пищевого поведения",
    ...
    topics: [
...

      {
        ...
        description: "почему мысли становятся навязчивыми и как формируется цикл РПП"
      },

      {
        id: "rpp-compensation",
        title: "компенсаторное поведение",
        description: "что скрывается за ограничениями, очищением и чрезмерной активностью"
      },

      {
        id: "rpp-recovery",
        title: "восстановление",
        description: "что происходит с телом и психикой во время восстановления"
      }
    ]
  },
  ...
  medical: {
    ...
    description:
      "разбираемся, что происходит с организмом на самом деле, без магии маркетплейсов и страшилок из интернета.",

    topics: [
      {
        id: "medical-weight",
        title: "почему меняется вес",
        description: "жир, вода, гликоген и содержимое кишечника"
      },

      {
        id: "medical-bloating",
        title: "откуда берется вздутие",
        description: "почему живот может меняться в течение одного дня"
      },

      {
        id: "medical-hormones",
        title: "вес и гормоны",
        description: "что гормоны действительно могут менять, а что им приписывают зря"
      }
    ]
  },
  ...
  supplements: {
    ...
    kicker: "добавки и препараты",

    description:
      "как читать состав, распознавать маркетинговые обещания и замечать потенциально опасные компоненты.",

    topics: [
      {
        id: "supplements-label",
        title: "как читать состав",
        description: "действующее вещество, дозировка и маркетинговые формулировки"
      },

      {
        id: "supplements-evidence",
        title: "доказательность",
        description: "чем научные данные отличаются от отзывов и обещаний продавца"
      },

      {
        id: "supplements-risks",
        title: "риски БАДов",
        description: "почему «натуральный» не означает безопасный"
      }
    ]
  },
  ...
  tools: {
    ...
    kicker: "полезные расчеты",

    description:
      "небольшие инструменты для работы с цифрами и медицинской информацией. расчеты носят справочный характер.",

    topics: [
      {
        id: "tools-bmi",
        title: "ИМТ",
        description: "справочный расчет индекса массы тела"
      },

      {
        id: "tools-calories",
        title: "энергетический баланс",
        description: "разбираемся, что такое основной обмен и энергозатраты"
      },

      {
        id: "tools-labels",
        title: "разбор этикетки",
        description: "как смотреть на калорийность, БЖУ и состав продукта"
      }
    ]
  }
