...
const articles = {
  ...
  "medical-vitamins": {
    ...
    pages: [

      {
        ...
        content: `
          ...
          <ul>
            ...
            <li>Алимемазин (Тералиджен <b>с осторожностью</b>)</li>
      ...
      <div class="info-box">
            <p>
            <b>Селективные Ингибиторы Обратного Захата Серотонина и подобные им антидепрессанты НЕЛЬЗЯ
          ...
          <h3>остальные запрещенные на курсе препараты</h3>    
