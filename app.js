...
const content = {
  ...
  rpp: {
    ...
    body: `
      <p class="note">
        этот раздел не для контроля себя, а для того, чтобы проверить
        есть ли у тебя РПП.
      </p>
  ...
  supplements: {
    ...
    body: `
      <p class="note">
        карточки БАДов, их описание, дозировка, правила приема
        и многое другое.
      </p>
  ...
  tools: {
    ...
    body: `
      ...
      <p>
        здесь будут расчеты на основании введенных параметров.
      </p>

      <div class="note">
        калькулятор ИМТ и энергетический расчет добавим следующим этапом.
      </div>
      ...
      <ul>
        ...
        <li>информационные материалы о БАДах</li>
        <li>расчетные инструменты</li>
      </ul>
    `
  }
  ...
  "rpp-thoughts": {
    ...
    pages: [
      ...
      `
        ...
        <p>
          здесь будет первая часть материала.
        </p>
      `,
      ...
      `
        ...
        <p>
          здесь будет вторая часть материала.
        </p>
      `
  ...
  "rpp-compensation": {
    ...
    pages: [
      ...
      `
        <h3>почему возникает позыв к компенсации</h3>

        <p>
          здесь будет материал о механизмах компенсаторного поведения.
        </p>
      `
  ...
  "rpp-recovery": {
    ...
    pages: [
      ...
      `
        <h3>почему восстановление идет неровно</h3>

        <p>
          здесь будет материал о том, почему восстановление
          не обязательно выглядит линейным процессом.
        </p>
      `
