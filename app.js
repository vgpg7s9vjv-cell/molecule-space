  ...
  "rpp-basics": {
    ...
    pages: [

      {
        ...
        content: `
          ...
          <p>
            ...
            это когда внутри живет огромная, болезненная нелюбовь к себе
            и кажется, что если ты уменьшишься в размерах, то эта пустота исчезнет, а тебя, наконец, полюбят и оценят
...

      {
        ...
        content: `
          <p>
              <b>орторексия</b> — одержимость «чистым» питанием
              это не просто желание питаться правильно, это настоящая мания и страх съесть что-то «вредное». человек делит еду на «правильную» и «токсичную»
              и выбирает еду не по вкусу или чувству голода, а по составу
              нарушение собственных правил вызывает у него панику и жесткое самобичевание
          </p>
              <div class="info-box">
            <p>
              если в гостях или ресторане нет еды с идеальным «чистым» составом, орторексик предпочтет остаться голодным
            </p>
            </div>
            
          <p>
               <b>дранкорексия</b> — алкоголь вместо еды
               это расстройство, при котором человек намеренно отказывается от еды, чтобы «сэкономить» калории для алкоголя
               другой вариант дранкорексии — когда после вечеринки с алкоголем человек устраивает себе жесткие голодовки или изнурительные тренировки,
               чтобы «отработать» выпитое
          </p>
              <div class="info-box">
            <p>
              вместо полноценного обеда или ужина дранкорексик выбирает выпивку, потому что боится поправиться от лишних калорий в спиртном
            </p>
            </div>
            
          <p>
            <b>булимия</b> — замкнутый круг «срыв-наказание»
            это расстройство, которое проявляется приступами неконтролируемого переедания,
            после которых человек пытается экстренно «очистить» организм
          </p>
              <div class="info-box">
            <p>
             булимик за один раз может съесть огромное количество еды (часто прячась от других),
             а потом, испытывая дикий стыд и вину, бежит вызывать рвоту,
             пьет слабительные или бежит на дорожку в спортзал, чтобы «стереть» этот срыв            
             </p>
            </div>

            <p>
               <b>преорексия</b> — одержимость спортом в положении
               расстройство, при котором беременные женщины изнуряют себя диетами и фитнесом, 
               панически боясь набрать вес во время вынашивания ребенка
            </p>

            <p>
                <b>бигорексия (мужская анорексия)</b> — когда человеку кажется, 
                что он слишком худой и «хилый», даже если он уже выглядит как профессиональный бодибилдер 
