  ...
  "medical-vitamins": {
    ...
    pages: [
      ...
      <div class="info-box">
         ...
         <h3>🔻 прочие препараты, которые не следует пить</h3>
       ...
       
      {
        ...
        content: `
            ...
            ❕<b>предупреждение</b>: витамины <b>не являются обязательными для приема на курсе</b><br>
             ...
             <br>
             ❇️ <b>принимать витамины – рекомендация, а не правило приема!</b>
             </p>
...

      {
        ...
        content: `
             <h3>🔻 спортБАДы L-триптофан и 5-HTP</h3>
           <ul>  
