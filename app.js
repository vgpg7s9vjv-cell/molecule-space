...
style="width: 100%; height: auto; border-radius: 12px; margin: 15px 0; display: block;">
  ...
  "medical-vitamins": {
    ...
    pages: [

      {
        ...
        content: `
          ...
          <ul>
            ...
            <li>Алимемазин (Тералиджен <b><i>с осторожностью</i></b>)</li>
...

      {
        ...
        content: `
         ...
         <h3>антигистаминные (противоаллергенные)</h3>
          ...
          <h3>СИОЗС и другие антидепрессанты</h3>
          
      <div class="info-box">
            <p>
            <b>Селективные Ингибиторы Обратного Захвата Серотонина и подобные им антидепрессанты НЕЛЬЗЯ
      ...
      <div class="info-box">
            <p>
           при приеме высоких доз магний может оказывать слабительное действие<br>
