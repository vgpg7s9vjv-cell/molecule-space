...
const sections = {
  ...
  supplements: {
    title: "БАДовый минимум знаний и роскошный максимум информации",

    kicker: "состав, правила приема, отличия, побочки, помощь в выборе и многое другое",

    description:
      "правила приема, отличия, побочки, выбрать нужную",

    topics: [
      {
        id: "supplements-label",
        title: "состав, правила приема",
